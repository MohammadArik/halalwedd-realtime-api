...
type ServerHandlingClient interface {
	...
	NotifyExit(ctx context.Context, in *NotifyExitReq, opts ...grpc.CallOption) (*NotifyExitRes, error)
}
...
type ServerHandlingServer interface {
	...
	NotifyExit(context.Context, *NotifyExitReq) (*NotifyExitRes, error)
...
func (UnimplementedServerHandlingServer) NotifyExit(context.Context, *NotifyExitReq) (*NotifyExitRes, error) {
...
func _ServerHandling_NotifyExit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NotifyExitReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServerHandlingServer).NotifyExit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var ServerHandling_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ServerHandling_NotifyExit_Handler,
		},
	},
